...
function getTimelineWindow(zoom, items = []) {
  ...
  const earliestItemStart = datedItems.length
    ? new Date(Math.min(...datedItems.map((item) => item.start.getTime())))
    : currentWeekStart;
...
function getTimelineUnitWidth(zoom) {
